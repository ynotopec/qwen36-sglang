...
PATCH_TRANSFORMERS_CONFIG_COLLISIONS="${PATCH_TRANSFORMERS_CONFIG_COLLISIONS:-0}"
...
docker build \
  ...
  --build-arg PATCH_TRANSFORMERS_CONFIG_COLLISIONS="${PATCH_TRANSFORMERS_CONFIG_COLLISIONS}" \
